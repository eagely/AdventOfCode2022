...
class Day11 : AdventOfCode("src/main/resources/InputD11.aoc") {
    ...
    override fun solvePart1(): String {
        ...
        return getWorryWithRelief(input, 20).toString()
    }

    override fun solvePart2(): String {
        val input = getInput().readLines()
        return getWorry(input, 10000).toString()
    }
    ...
    private fun getStartingItems(input: List<String>): ArrayList<ArrayList<Long>> {
        ...
        for (i in 0 until getAmountOfMonkeys(input))
    ...
    private fun getWorryWithRelief(input: List<String>, rounds: Int): Long {
        ...
        for (round in 0 until rounds)
            for (monkey in 0 until getAmountOfMonkeys(input))
    ...
    private fun getWorry(input: List<String>, rounds: Int): Long {
        val operation = getOperation(input)
        val test = getTest(input)
        val trueResult = getTrueResult(input)
        val falseResult = getFalseResult(input)
